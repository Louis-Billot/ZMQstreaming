...
print(cmd.format("{}_mono1.h264".format(now.strftime("%y-%m-%d_%H-%M-%S")), "mono1.mp4"))
print(cmd.format("{}_mono2.h264".format(now.strftime("%y-%m-%d_%H-%M-%S")), "mono2.mp4"))
print(cmd.format("{}_color.h265".format(now.strftime("%y-%m-%d_%H-%M-%S")), "color.mp4"))